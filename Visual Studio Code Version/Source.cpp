...
void INIT(SDL_Renderer* &render, SDL_Window* &window) {
	...
	window = SDL_CreateWindow("Game of Life", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, WIDHT, HEIGHT, SDL_WINDOW_SHOWN);
...
int main(int argc, char** argv) {
	...
	SDL_Texture* buttons = IMG_LoadTexture(render, "./pictures/buttons.png");
	SDL_Texture* texts = IMG_LoadTexture(render, "./pictures/text.png");
